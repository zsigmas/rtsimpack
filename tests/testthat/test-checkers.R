...
test_that('Number of trials checker',
          {
            ...
            expect_equal(check_ntrial(same_it), TRUE)
            expect_equal(check_ntrial(same_no_it), TRUE)
            expect_equal(check_ntrial(diff_it), FALSE)
            expect_equal(check_ntrial(diff_no_it), FALSE)
          })
